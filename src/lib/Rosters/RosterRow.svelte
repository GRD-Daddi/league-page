...
<tr>
        <td class="slot playerCell"><span class="pos {playerSLotClass}">{playerSlot}</span></td>
        {#if player.avatar}
                <td class="avatar playerCell">
        ...
        {/if}
        <td class="playerCell nameCell" colspan={player.name != "Empty" ? 1 : 3}>
        <div class="info">
            <!-- name -->
            {@html player.name}
            <!-- name -->
