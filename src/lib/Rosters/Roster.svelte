...
<div class="team">
        <table class="sn-table teamInner" aria-label="Team Name" style="width: {innerWidth * 0.95 > 380 ? 380 : innerWidth * 0.95}px;" >
                <thead> <!-- Team name  -->
                        <tr>
                                <th colspan="4" class="r_{division} clickable">
                ...
                <tbody>
                        ...
                        {/each}
                        <tr class="interactive" onclick={toggleSelected}>
                                <td colspan="4" class="{division}"><h5><span class="material-icons icon">king_bed</span> Bench <span class="italic">({status})</span></h5></td>
                        </tr>
                </tbody>
        </table>
        <div class="rosterBench" style="max-height: {selected}">
                <table class="sn-table teamInner" style="width: 380px" >
                        <tbody class="bench">
                                <!--    Bench    -->
                                ...
                                {#if finalIR}
                                        <tr>
                                        <td colspan="4" ><h5><span class="material-icons icon">healing</span> Injured Reserve</h5></td>
                                        </tr>
                                        {#each finalIR as ir}
                                                <RosterRow player={ir} />
                                        {/each}
                                {/if}
                                <tr class="interactive" onclick={toggleSelected}>
                                        <td colspan="4" class="{division}"><h5><span class="material-icons icon">close_fullscreen</span>Close Bench</h5></td>
                                </tr>
                        </tbody>
                </table>
        </div>
