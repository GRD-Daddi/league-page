...
<style>
    ...
    .mb-fill.home {
        left: 0;
        background: linear-gradient(to right, rgba(204, 255, 0, 0.16) 0%, rgba(204, 255, 0, 0.12) 55%, rgba(204, 255, 0, 0.09) 100%);
        clip-path: polygon(0 0, 100% 0, calc(100% - 22px) 100%, 0 100%);
    }
    .mb-fill.away {
        right: 0;
        background: linear-gradient(to left, rgba(204, 255, 0, 0.16) 0%, rgba(204, 255, 0, 0.12) 55%, rgba(204, 255, 0, 0.09) 100%);
