...
export async function GET({ locals }) {
    ...
    const numPlayoffTeams = leagueData.settings.playoff_teams || 4;
    const playoffLength = Math.ceil(Math.log2(numPlayoffTeams)); // e.g., 4 teams = 2 rounds, 6 teams = 3 rounds
