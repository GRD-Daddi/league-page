...
<div class="sn-page">
        ...
        <div class="sn-container">
                ...
                {#if careers.length}
                        <section class="records-section">
                                <div class="sn-section-header standings-header">
                                        <h2 class="sn-section-title">ALL-TIME STANDINGS</h2>
                                        {#if hasCurrentFlag}
                                                <div class="member-toggle" role="group" aria-label="Filter managers">
                                                        <button type="button" class="toggle-btn" class:active={!currentOnly} aria-pressed={!currentOnly} on:click={() => (currentOnly = false)}>All managers</button>
                                                        <button type="button" class="toggle-btn" class:active={currentOnly} aria-pressed={currentOnly} on:click={() => (currentOnly = true)}>Current members</button>
                                                </div>
                                        {/if}
                                </div>
                                ...
                                <div class="sn-card career-table-wrap">
                                        <table class="career-table">
                                                ...
                                                <tbody>
                                                        {#each visibleCareers as c, i (c.owner)}
...
<style>
        ...
        .toggle-btn.active { background: var(--sn-lime); color: #0f1115; }
